    ...
    return (
        <section className="h-auto mx-auto max-w-[1200px]">
            ...
            <div className="grid grid-cols-3 grid-rows-3 gap-y-8 h-[97%] w-full rounded-[10px] my-8">
                <div className=" flex flex-col justify-start w-[23rem] h-96 m-auto rounded-[5px] bg-slate-300 relative">
                    <div className="h-[28%] w-full py-[0.3rem] px-[0.5rem] mt-[40%] relative mx-auto flex flex-col justify-evenly items-center text-center bg-[rgb(20,53,107,0.62)] z-10">
                    ...
                    <Image src={Fumigacion} alt="Image1" className="absolute object-cover bg-no-repeat" fill />
                </div>
